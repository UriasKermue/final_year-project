...
import axios from "axios";
import { FaUserCircle } from "react-icons/fa";
import NotificationBell from "../Components2/NotificationBell"; // Import NotificationBell
...
const Header = () => {
  ...
  return (
    <Box>
      ...
      {/* Second Header (Flat Background Color, Reduced Height) */}
      <AppBar position="static" style={{ backgroundColor: "#1976d2", height: "40px" }}>
        <Toolbar style={{ minHeight: "40px" }}>
          <Typography variant="body2" style={{ flexGrow: 1, fontFamily: "Arial, sans-serif", color: "#fff" }}>
            Contact us: (555) 555-5555 | Email: info@healthheaven.com
          </Typography>
          <Button color="inherit" component={Link} to="/about">
            <InfoIcon style={iconStyle} /> About Us
